...
In my PhD, I go back and forth between the Statistical Physics of Disordered Systems and Theoretical Community Ecology. On one hand systems of interacting species can be studied with the tools developed for randomly interacting spins. On the other hand, the dynamics of ecosystems is characterized by non-equilibrium features that are not found in classical disordered systems models, such as non-reciprocal interactions and migration, which makes it interesting also from the theoretical point of view.
